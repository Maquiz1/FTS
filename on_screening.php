...
<head>
    ...
    <title>IHI - KINGANI | List of Screened</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Screened List</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard1.php">Home</a></li>
                                <li class="breadcrumb-item active">Screened</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Current List of Screened Subjects</h3>
                            </div>
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $y = 1;
                                        foreach ($override->getDataOrderByAsc('clients', 'study_id', 'status', 2) as $client) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if ($client['current_status'] == 1) {
                                                    ?>
                                                    <div class="btn-group btn-group-xs"><button class="btn btn-success">On Screening</button></div>
                                                    <?php
                                                                                                                                                } elseif ($client['current_status'] == 2) {
                                                                                                                                                    ?>

                                                        <div class="btn-group btn-group-xs"><button class="btn btn-danger">Eligible</button></div>
                                                    ...
                                                    <?php
                                                        ...
                                                        <div class="btn-group btn-group-xs"><button class="btn btn-danger">Not Eligible</button></div>   
                                                        <?php }?>                                                 
                                                </td>
                                                <td><?= $client['reason'] ?></td>

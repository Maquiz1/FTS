                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $y = 1;
                                        foreach ($override->getDataOrderByAsc('clients', 'study_id', 'status', 1) as $client) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?><div class="btn-group btn-group-xs"><button class="btn btn-success">Active</button></div><?php
                                                        ...
                                                        <div class="btn-group btn-group-xs"><button class="btn btn-danger">Not Active</button></div>
